...
class Update2 extends StatefulWidget {
  final V1, V2, V3;
  const Update2(this.V1, this.V2, this.V3);
...
class _Update2State extends State<Update2> {
  ...
  Future updateTodo() async {
    var url = Uri.http('192.168.1.136:8000', '/api/update-devicelist2/$_V1');
  ...
  Future deleteTodo() async {
    var url = Uri.http('192.168.1.136:8000', '/api/delete-devicelist2/$_V1');
    Map<String, String> header = {'Content-type': 'application/json'};
