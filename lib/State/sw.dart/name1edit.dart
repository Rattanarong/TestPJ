...
class name1edit extends StatefulWidget {
  final V1, V2;
  const name1edit(
    this.V1,
    this.V2,
  ...
  @override
  _name1editState createState() => _name1editState();
}

class _name1editState extends State<name1edit> {
  var _V1, _V2;
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: ElevatedButton(
                onPressed: () {
                  print('---------------');
                  print('username: ${namesw1Controller.text}');
                  updateTodo();
  ...
  Future updateTodo() async {
    var url = Uri.http('192.168.1.120:8000', '/api/update-devicelist1/$_V1');
    Map<String, String> header = {'Content-type': 'application/json'};
    String jsondata = '{"namesw1":"${namesw1Controller.text}"}';
