...
class name3edit extends StatefulWidget {
  final V1, V2;
  const name3edit(
    this.V1,
    this.V2,
  ...
  @override
  _name3editState createState() => _name3editState();
}

class _name3editState extends State<name3edit> {
  var _V1, _V2;
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: ElevatedButton(
                onPressed: () {
                  print('---------------');
                  print('username: ${namesw22Controller.text}');
                  updateTodo();
  ...
  Future updateTodo() async {
    ...
    String jsondata = '{"namesw22":"${namesw22Controller.text}"}';
