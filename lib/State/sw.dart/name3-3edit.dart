...
class name6edit extends StatefulWidget {
  final V1, V2;
  const name6edit(
    this.V1,
    this.V2,
  ...
  @override
  _name6editState createState() => _name6editState();
}

class _name6editState extends State<name6edit> {
  var _V1, _V2;
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: ElevatedButton(
                onPressed: () {
                  print('---------------');
                  print('username: ${namesw33Controller.text}');
                  updateTodo();
  ...
  Future updateTodo() async {
    ...
    String jsondata = '{"namesw33":"${namesw33Controller.text}"}';
